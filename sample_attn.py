...
checkpoint_path = 'runs/test-autoregressive-attn-alibi-reccurent'
...
model=AutoregressiveChar(tokenizer.vocab_size,internal_dim,layers=layers,mlp_factor=mlp_factor,impl='attn',recurrence=reccurence)
